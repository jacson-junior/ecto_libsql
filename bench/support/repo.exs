...
Application.put_env(
  :ecto_sql,
  Ecto.Bench.SQLite3Repo,
  adapter: Ecto.Adapters.SQLite3,
  mode: :local,
  path: "/tmp/SQLite3_bench.db",
  journal_mode: :wal,
  cache_size: -64000,
  temp_store: :memory,
  pool_size: 5,
...
defmodule Ecto.Bench.SQLite3Repo do
  use Ecto.Repo, otp_app: :ecto_sql, adapter: Ecto.Adapters.SQLite3, log: false
end
